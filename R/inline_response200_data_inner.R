#' Create a new InlineResponse200DataInner
#'
#' @description
#' InlineResponse200DataInner Class
#'
#' @docType class
#' @title InlineResponse200DataInner
#' @description InlineResponse200DataInner Class
...
#' @field chill_hours_7C  integer [optional]
...
#' @field heatstress_cotton_meanF  integer [optional]
...
#' @export
InlineResponse200DataInner <- R6::R6Class(
  "InlineResponse200DataInner",
  public = list(
    `chill_hours_0C` = NULL,
    ...
    #' Initialize a new InlineResponse200DataInner class.
    #'
    #' @description
    #' Initialize a new InlineResponse200DataInner class.
    #'
    ...
    #' @export
    initialize = function(
        `chill_hours_0C` = NULL, `chill_hours_20C` = NULL, `chill_hours_32F` = NULL, `chill_hours_45F` = NULL, `chill_hours_68F` = NULL, `chill_hours_7C` = NULL, `date_doy` = NULL, `date_year` = NULL, `datetime` = NULL, `dwpt_mean` = NULL, `dwpt_meanF` = NULL, `eto_azmet` = NULL, `eto_azmet_in` = NULL, `eto_pen_mon` = NULL, `eto_pen_mon_in` = NULL, `heat_units_10C` = NULL, `heat_units_13C` = NULL, `heat_units_3413C` = NULL, `heat_units_45F` = NULL, `heat_units_50F` = NULL, `heat_units_55F` = NULL, `heat_units_7C` = NULL, `heat_units_9455F` = NULL, `heatstress_cotton_meanC` = NULL, `heatstress_cotton_meanF` = NULL, `meta_bat_volt_max` = NULL, `meta_bat_volt_mean` = NULL, `meta_bat_volt_min` = NULL, `meta_needs_review` = NULL, `meta_station_id` = NULL, `meta_station_name` = NULL, `meta_version` = NULL, `precip_total_mm` = NULL, `precip_total_in` = NULL, `relative_humidity_max` = NULL, `relative_humidity_mean` = NULL, `relative_humidity_min` = NULL, `sol_rad_total` = NULL, `sol_rad_total_ly` = NULL, `temp_air_maxC` = NULL, `temp_air_maxF` = NULL, `temp_air_meanC` = NULL, `temp_air_meanF` = NULL, `temp_air_minC` = NULL, `temp_air_minF` = NULL, `temp_soil_10cm_maxC` = NULL, `temp_soil_10cm_maxF` = NULL, `temp_soil_10cm_meanC` = NULL, `temp_soil_10cm_meanF` = NULL, `temp_soil_10cm_minC` = NULL, `temp_soil_10cm_minF` = NULL, `temp_soil_50cm_maxC` = NULL, `temp_soil_50cm_maxF` = NULL, `temp_soil_50cm_meanC` = NULL, `temp_soil_50cm_meanF` = NULL, `temp_soil_50cm_minC` = NULL, `temp_soil_50cm_minF` = NULL, `vp_actual_max` = NULL, `vp_actual_mean` = NULL, `vp_actual_min` = NULL, `vp_deficit_mean` = NULL, `wind_spd_max_mph` = NULL, `wind_spd_max_mps` = NULL, `wind_spd_mean_mph` = NULL, `wind_spd_mean_mps` = NULL, `wind_vector_dir` = NULL, `wind_vector_dir_stand_dev` = NULL, `wind_vector_magnitude` = NULL, `wind_vector_magnitude_mph` = NULL, ...
    ) {
      ...
      if (!is.null(`chill_hours_7C`)) {
        stopifnot(is.numeric(`chill_hours_7C`), length(`chill_hours_7C`) == 1)
      ...
      if (!is.null(`heatstress_cotton_meanF`)) {
        stopifnot(is.numeric(`heatstress_cotton_meanF`), length(`heatstress_cotton_meanF`) == 1)
      ...
      if (!is.null(`meta_needs_review`)) {
        stopifnot(is.character(`meta_needs_review`), length(`meta_needs_review`) == 1)
      ...
      if (!is.null(`meta_version`)) {
        stopifnot(is.character(`meta_version`), length(`meta_version`) == 1)
    ...
    #' To JSON String
    #'
    #' @return InlineResponse200DataInner in JSON format
    #' @export
    toJSON = function() {
      InlineResponse200DataInnerObject <- list()
      if (!is.null(self$`chill_hours_0C`)) {
        InlineResponse200DataInnerObject[["chill_hours_0C"]] <-
          self$`chill_hours_0C`
      }
      if (!is.null(self$`chill_hours_20C`)) {
        InlineResponse200DataInnerObject[["chill_hours_20C"]] <-
          self$`chill_hours_20C`
      }
      if (!is.null(self$`chill_hours_32F`)) {
        InlineResponse200DataInnerObject[["chill_hours_32F"]] <-
          self$`chill_hours_32F`
      }
      if (!is.null(self$`chill_hours_45F`)) {
        InlineResponse200DataInnerObject[["chill_hours_45F"]] <-
          self$`chill_hours_45F`
      }
      if (!is.null(self$`chill_hours_68F`)) {
        InlineResponse200DataInnerObject[["chill_hours_68F"]] <-
          self$`chill_hours_68F`
      }
      if (!is.null(self$`chill_hours_7C`)) {
        InlineResponse200DataInnerObject[["chill_hours_7C"]] <-
          self$`chill_hours_7C`
      }
      if (!is.null(self$`date_doy`)) {
        InlineResponse200DataInnerObject[["date_doy"]] <-
          self$`date_doy`
      }
      if (!is.null(self$`date_year`)) {
        InlineResponse200DataInnerObject[["date_year"]] <-
          self$`date_year`
      }
      if (!is.null(self$`datetime`)) {
        InlineResponse200DataInnerObject[["datetime"]] <-
          self$`datetime`
      }
      if (!is.null(self$`dwpt_mean`)) {
        InlineResponse200DataInnerObject[["dwpt_mean"]] <-
          self$`dwpt_mean`
      }
      if (!is.null(self$`dwpt_meanF`)) {
        InlineResponse200DataInnerObject[["dwpt_meanF"]] <-
          self$`dwpt_meanF`
      }
      if (!is.null(self$`eto_azmet`)) {
        InlineResponse200DataInnerObject[["eto_azmet"]] <-
          self$`eto_azmet`
      }
      if (!is.null(self$`eto_azmet_in`)) {
        InlineResponse200DataInnerObject[["eto_azmet_in"]] <-
          self$`eto_azmet_in`
      }
      if (!is.null(self$`eto_pen_mon`)) {
        InlineResponse200DataInnerObject[["eto_pen_mon"]] <-
          self$`eto_pen_mon`
      }
      if (!is.null(self$`eto_pen_mon_in`)) {
        InlineResponse200DataInnerObject[["eto_pen_mon_in"]] <-
          self$`eto_pen_mon_in`
      }
      if (!is.null(self$`heat_units_10C`)) {
        InlineResponse200DataInnerObject[["heat_units_10C"]] <-
          self$`heat_units_10C`
      }
      if (!is.null(self$`heat_units_13C`)) {
        InlineResponse200DataInnerObject[["heat_units_13C"]] <-
          self$`heat_units_13C`
      }
      if (!is.null(self$`heat_units_3413C`)) {
        InlineResponse200DataInnerObject[["heat_units_3413C"]] <-
          self$`heat_units_3413C`
      }
      if (!is.null(self$`heat_units_45F`)) {
        InlineResponse200DataInnerObject[["heat_units_45F"]] <-
          self$`heat_units_45F`
      }
      if (!is.null(self$`heat_units_50F`)) {
        InlineResponse200DataInnerObject[["heat_units_50F"]] <-
          self$`heat_units_50F`
      }
      if (!is.null(self$`heat_units_55F`)) {
        InlineResponse200DataInnerObject[["heat_units_55F"]] <-
          self$`heat_units_55F`
      }
      if (!is.null(self$`heat_units_7C`)) {
        InlineResponse200DataInnerObject[["heat_units_7C"]] <-
          self$`heat_units_7C`
      }
      if (!is.null(self$`heat_units_9455F`)) {
        InlineResponse200DataInnerObject[["heat_units_9455F"]] <-
          self$`heat_units_9455F`
      }
      if (!is.null(self$`heatstress_cotton_meanC`)) {
        InlineResponse200DataInnerObject[["heatstress_cotton_meanC"]] <-
          self$`heatstress_cotton_meanC`
      }
      if (!is.null(self$`heatstress_cotton_meanF`)) {
        InlineResponse200DataInnerObject[["heatstress_cotton_meanF"]] <-
          self$`heatstress_cotton_meanF`
      }
      if (!is.null(self$`meta_bat_volt_max`)) {
        InlineResponse200DataInnerObject[["meta_bat_volt_max"]] <-
          self$`meta_bat_volt_max`
      }
      if (!is.null(self$`meta_bat_volt_mean`)) {
        InlineResponse200DataInnerObject[["meta_bat_volt_mean"]] <-
          self$`meta_bat_volt_mean`
      }
      if (!is.null(self$`meta_bat_volt_min`)) {
        InlineResponse200DataInnerObject[["meta_bat_volt_min"]] <-
          self$`meta_bat_volt_min`
      }
      if (!is.null(self$`meta_needs_review`)) {
        InlineResponse200DataInnerObject[["meta_needs_review"]] <-
          self$`meta_needs_review`
      }
      if (!is.null(self$`meta_station_id`)) {
        InlineResponse200DataInnerObject[["meta_station_id"]] <-
          self$`meta_station_id`
      }
      if (!is.null(self$`meta_station_name`)) {
        InlineResponse200DataInnerObject[["meta_station_name"]] <-
          self$`meta_station_name`
      }
      if (!is.null(self$`meta_version`)) {
        InlineResponse200DataInnerObject[["meta_version"]] <-
          self$`meta_version`
      }
      if (!is.null(self$`precip_total_mm`)) {
        InlineResponse200DataInnerObject[["precip_total_mm"]] <-
          self$`precip_total_mm`
      }
      if (!is.null(self$`precip_total_in`)) {
        InlineResponse200DataInnerObject[["precip_total_in"]] <-
          self$`precip_total_in`
      }
      if (!is.null(self$`relative_humidity_max`)) {
        InlineResponse200DataInnerObject[["relative_humidity_max"]] <-
          self$`relative_humidity_max`
      }
      if (!is.null(self$`relative_humidity_mean`)) {
        InlineResponse200DataInnerObject[["relative_humidity_mean"]] <-
          self$`relative_humidity_mean`
      }
      if (!is.null(self$`relative_humidity_min`)) {
        InlineResponse200DataInnerObject[["relative_humidity_min"]] <-
          self$`relative_humidity_min`
      }
      if (!is.null(self$`sol_rad_total`)) {
        InlineResponse200DataInnerObject[["sol_rad_total"]] <-
          self$`sol_rad_total`
      }
      if (!is.null(self$`sol_rad_total_ly`)) {
        InlineResponse200DataInnerObject[["sol_rad_total_ly"]] <-
          self$`sol_rad_total_ly`
      }
      if (!is.null(self$`temp_air_maxC`)) {
        InlineResponse200DataInnerObject[["temp_air_maxC"]] <-
          self$`temp_air_maxC`
      }
      if (!is.null(self$`temp_air_maxF`)) {
        InlineResponse200DataInnerObject[["temp_air_maxF"]] <-
          self$`temp_air_maxF`
      }
      if (!is.null(self$`temp_air_meanC`)) {
        InlineResponse200DataInnerObject[["temp_air_meanC"]] <-
          self$`temp_air_meanC`
      }
      if (!is.null(self$`temp_air_meanF`)) {
        InlineResponse200DataInnerObject[["temp_air_meanF"]] <-
          self$`temp_air_meanF`
      }
      if (!is.null(self$`temp_air_minC`)) {
        InlineResponse200DataInnerObject[["temp_air_minC"]] <-
          self$`temp_air_minC`
      }
      if (!is.null(self$`temp_air_minF`)) {
        InlineResponse200DataInnerObject[["temp_air_minF"]] <-
          self$`temp_air_minF`
      }
      if (!is.null(self$`temp_soil_10cm_maxC`)) {
        InlineResponse200DataInnerObject[["temp_soil_10cm_maxC"]] <-
          self$`temp_soil_10cm_maxC`
      }
      if (!is.null(self$`temp_soil_10cm_maxF`)) {
        InlineResponse200DataInnerObject[["temp_soil_10cm_maxF"]] <-
          self$`temp_soil_10cm_maxF`
      }
      if (!is.null(self$`temp_soil_10cm_meanC`)) {
        InlineResponse200DataInnerObject[["temp_soil_10cm_meanC"]] <-
          self$`temp_soil_10cm_meanC`
      }
      if (!is.null(self$`temp_soil_10cm_meanF`)) {
        InlineResponse200DataInnerObject[["temp_soil_10cm_meanF"]] <-
          self$`temp_soil_10cm_meanF`
      }
      if (!is.null(self$`temp_soil_10cm_minC`)) {
        InlineResponse200DataInnerObject[["temp_soil_10cm_minC"]] <-
          self$`temp_soil_10cm_minC`
      }
      if (!is.null(self$`temp_soil_10cm_minF`)) {
        InlineResponse200DataInnerObject[["temp_soil_10cm_minF"]] <-
          self$`temp_soil_10cm_minF`
      }
      if (!is.null(self$`temp_soil_50cm_maxC`)) {
        InlineResponse200DataInnerObject[["temp_soil_50cm_maxC"]] <-
          self$`temp_soil_50cm_maxC`
      }
      if (!is.null(self$`temp_soil_50cm_maxF`)) {
        InlineResponse200DataInnerObject[["temp_soil_50cm_maxF"]] <-
          self$`temp_soil_50cm_maxF`
      }
      if (!is.null(self$`temp_soil_50cm_meanC`)) {
        InlineResponse200DataInnerObject[["temp_soil_50cm_meanC"]] <-
          self$`temp_soil_50cm_meanC`
      }
      if (!is.null(self$`temp_soil_50cm_meanF`)) {
        InlineResponse200DataInnerObject[["temp_soil_50cm_meanF"]] <-
          self$`temp_soil_50cm_meanF`
      }
      if (!is.null(self$`temp_soil_50cm_minC`)) {
        InlineResponse200DataInnerObject[["temp_soil_50cm_minC"]] <-
          self$`temp_soil_50cm_minC`
      }
      if (!is.null(self$`temp_soil_50cm_minF`)) {
        InlineResponse200DataInnerObject[["temp_soil_50cm_minF"]] <-
          self$`temp_soil_50cm_minF`
      }
      if (!is.null(self$`vp_actual_max`)) {
        InlineResponse200DataInnerObject[["vp_actual_max"]] <-
          self$`vp_actual_max`
      }
      if (!is.null(self$`vp_actual_mean`)) {
        InlineResponse200DataInnerObject[["vp_actual_mean"]] <-
          self$`vp_actual_mean`
      }
      if (!is.null(self$`vp_actual_min`)) {
        InlineResponse200DataInnerObject[["vp_actual_min"]] <-
          self$`vp_actual_min`
      }
      if (!is.null(self$`vp_deficit_mean`)) {
        InlineResponse200DataInnerObject[["vp_deficit_mean"]] <-
          self$`vp_deficit_mean`
      }
      if (!is.null(self$`wind_spd_max_mph`)) {
        InlineResponse200DataInnerObject[["wind_spd_max_mph"]] <-
          self$`wind_spd_max_mph`
      }
      if (!is.null(self$`wind_spd_max_mps`)) {
        InlineResponse200DataInnerObject[["wind_spd_max_mps"]] <-
          self$`wind_spd_max_mps`
      }
      if (!is.null(self$`wind_spd_mean_mph`)) {
        InlineResponse200DataInnerObject[["wind_spd_mean_mph"]] <-
          self$`wind_spd_mean_mph`
      }
      if (!is.null(self$`wind_spd_mean_mps`)) {
        InlineResponse200DataInnerObject[["wind_spd_mean_mps"]] <-
          self$`wind_spd_mean_mps`
      }
      if (!is.null(self$`wind_vector_dir`)) {
        InlineResponse200DataInnerObject[["wind_vector_dir"]] <-
          self$`wind_vector_dir`
      }
      if (!is.null(self$`wind_vector_dir_stand_dev`)) {
        InlineResponse200DataInnerObject[["wind_vector_dir_stand_dev"]] <-
          self$`wind_vector_dir_stand_dev`
      }
      if (!is.null(self$`wind_vector_magnitude`)) {
        InlineResponse200DataInnerObject[["wind_vector_magnitude"]] <-
          self$`wind_vector_magnitude`
      }
      if (!is.null(self$`wind_vector_magnitude_mph`)) {
        InlineResponse200DataInnerObject[["wind_vector_magnitude_mph"]] <-
          self$`wind_vector_magnitude_mph`
      }
      InlineResponse200DataInnerObject
    },
    #' Deserialize JSON string into an instance of InlineResponse200DataInner
    #'
    #' @description
    #' Deserialize JSON string into an instance of InlineResponse200DataInner
    #'
    #' @param input_json the JSON input
    #' @return the instance of InlineResponse200DataInner
    #' @export
    ...
    #' Validate JSON input with respect to InlineResponse200DataInner
    #'
    #' @description
    #' Validate JSON input with respect to InlineResponse200DataInner and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of InlineResponse200DataInner
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#InlineResponse200DataInner$unlock()
#
## Below is an example to define the print fnuction
#InlineResponse200DataInner$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#InlineResponse200DataInner$lock()
