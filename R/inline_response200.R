#' Create a new InlineResponse200
#'
#' @description
...
#' @field data  list(\link{InlineResponse200DataInner}) [optional]
...
InlineResponse200 <- R6::R6Class(
  ...
  public = list(
    ...
    `s` = NULL,
    `t` = NULL,
    #' Initialize a new InlineResponse200 class.
    #'
    #' @description
    #' Initialize a new InlineResponse200 class.
    #'
    ...
    #' To JSON String
    #'
    #' @return InlineResponse200 in JSON format
    #' @export
    toJSON = function() {
      ...
      if (!is.null(self$`errors`)) {
        InlineResponse200Object[["errors"]] <-
          self$`errors`
      }
      if (!is.null(self$`i`)) {
        InlineResponse200Object[["i"]] <-
          self$`i`
      }
      if (!is.null(self$`l`)) {
        InlineResponse200Object[["l"]] <-
          self$`l`
      }
      if (!is.null(self$`s`)) {
        InlineResponse200Object[["s"]] <-
          self$`s`
      }
      if (!is.null(self$`t`)) {
        InlineResponse200Object[["t"]] <-
          self$`t`
      }
      InlineResponse200Object
    },
    #' Deserialize JSON string into an instance of InlineResponse200
    #'
    #' @description
    #' Deserialize JSON string into an instance of InlineResponse200
    #'
    #' @param input_json the JSON input
    #' @return the instance of InlineResponse200
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[InlineResponse200DataInner]", loadNamespace("azmet"))
      }
...
',
    ...
    #' Validate JSON input with respect to InlineResponse200
    #'
    #' @description
    #' Validate JSON input with respect to InlineResponse200 and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of InlineResponse200
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#InlineResponse200$unlock()
#
## Below is an example to define the print fnuction
#InlineResponse200$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#InlineResponse200$lock()
