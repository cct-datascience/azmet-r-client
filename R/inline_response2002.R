#' Create a new InlineResponse2002
#'
#' @description
...
#' @field data  list(\link{InlineResponse2002DataInner}) [optional]
...
InlineResponse2002 <- R6::R6Class(
  ...
  public = list(
    ...
    `s` = NULL,
    `t` = NULL,
    #' Initialize a new InlineResponse2002 class.
    #'
    #' @description
    #' Initialize a new InlineResponse2002 class.
    #'
    ...
    #' To JSON String
    #'
    #' @return InlineResponse2002 in JSON format
    #' @export
    toJSON = function() {
      InlineResponse2002Object <- list()
      if (!is.null(self$`data`)) {
        InlineResponse2002Object[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        InlineResponse2002Object[["errors"]] <-
          self$`errors`
      }
      if (!is.null(self$`i`)) {
        InlineResponse2002Object[["i"]] <-
          self$`i`
      }
      if (!is.null(self$`l`)) {
        InlineResponse2002Object[["l"]] <-
          self$`l`
      }
      if (!is.null(self$`s`)) {
        InlineResponse2002Object[["s"]] <-
          self$`s`
      }
      if (!is.null(self$`t`)) {
        InlineResponse2002Object[["t"]] <-
          self$`t`
      }
      InlineResponse2002Object
    },
    #' Deserialize JSON string into an instance of InlineResponse2002
    #'
    #' @description
    #' Deserialize JSON string into an instance of InlineResponse2002
    #'
    #' @param input_json the JSON input
    #' @return the instance of InlineResponse2002
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[InlineResponse2002DataInner]", loadNamespace("azmet"))
      }
...
',
    ...
    #' Validate JSON input with respect to InlineResponse2002
    #'
    #' @description
    #' Validate JSON input with respect to InlineResponse2002 and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of InlineResponse2002
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#InlineResponse2002$unlock()
#
## Below is an example to define the print fnuction
#InlineResponse2002$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#InlineResponse2002$lock()
