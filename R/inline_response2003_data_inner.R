...
#'
#' @docType class
#' @title InlineResponse2003DataInner
#' @description InlineResponse2003DataInner Class
...
#' @export
InlineResponse2003DataInner <- R6::R6Class(
  "InlineResponse2003DataInner",
  public = list(
    `date_year` = NULL,
    `precip_total` = NULL,
    `meta_version` = NULL,
    ...
    #' @export
    initialize = function(
        `date_year` = NULL, `precip_total` = NULL, `meta_version` = NULL, `wind_spd_max_mph` = NULL, `date_datetime` = NULL, `wind_vector_dir` = NULL, `wind_spd_mps` = NULL, `heatstress_cottonC` = NULL, `meta_station_id` = NULL, `date_doy` = NULL, `vp_actual` = NULL, `temp_airF` = NULL, `wind_spd_mph` = NULL, `temp_airC` = NULL, `eto_azmet_in` = NULL, `heatstress_cottonF` = NULL, `sol_rad_total` = NULL, `meta_bat_volt` = NULL, `precip_total_in` = NULL, `meta_needs_review` = NULL, `sol_rad_total_ly` = NULL, `eto_azmet` = NULL, `wind_vector_magnitude_mph` = NULL, `date_hour` = NULL, `temp_soil_10cmF` = NULL, `wind_vector_dir_stand_dev` = NULL, `vp_deficit` = NULL, `wind_spd_max_mps` = NULL, `dwptF` = NULL, `dwpt` = NULL, `wind_vector_magnitude` = NULL, `meta_station_name` = NULL, `temp_soil_50cmC` = NULL, `relative_humidity` = NULL, `temp_soil_10cmC` = NULL, `temp_soil_50cmF` = NULL, ...
    ) {
    ...
    #' To JSON String
    #'
    #' @return InlineResponse2003DataInner in JSON format
    #' @export
    toJSON = function() {
      InlineResponse2003DataInnerObject <- list()
      if (!is.null(self$`date_year`)) {
        InlineResponse2003DataInnerObject[["date_year"]] <-
          self$`date_year`
      }
      if (!is.null(self$`precip_total`)) {
        InlineResponse2003DataInnerObject[["precip_total"]] <-
          self$`precip_total`
      }
      if (!is.null(self$`meta_version`)) {
        InlineResponse2003DataInnerObject[["meta_version"]] <-
          self$`meta_version`
      }
      if (!is.null(self$`wind_spd_max_mph`)) {
        InlineResponse2003DataInnerObject[["wind_spd_max_mph"]] <-
          self$`wind_spd_max_mph`
      }
      if (!is.null(self$`date_datetime`)) {
        InlineResponse2003DataInnerObject[["date_datetime"]] <-
          self$`date_datetime`
      }
      if (!is.null(self$`wind_vector_dir`)) {
        InlineResponse2003DataInnerObject[["wind_vector_dir"]] <-
          self$`wind_vector_dir`
      }
      if (!is.null(self$`wind_spd_mps`)) {
        InlineResponse2003DataInnerObject[["wind_spd_mps"]] <-
          self$`wind_spd_mps`
      }
      if (!is.null(self$`heatstress_cottonC`)) {
        InlineResponse2003DataInnerObject[["heatstress_cottonC"]] <-
          self$`heatstress_cottonC`
      }
      if (!is.null(self$`meta_station_id`)) {
        InlineResponse2003DataInnerObject[["meta_station_id"]] <-
          self$`meta_station_id`
      }
      if (!is.null(self$`date_doy`)) {
        InlineResponse2003DataInnerObject[["date_doy"]] <-
          self$`date_doy`
      }
      if (!is.null(self$`vp_actual`)) {
        InlineResponse2003DataInnerObject[["vp_actual"]] <-
          self$`vp_actual`
      }
      if (!is.null(self$`temp_airF`)) {
        InlineResponse2003DataInnerObject[["temp_airF"]] <-
          self$`temp_airF`
      }
      if (!is.null(self$`wind_spd_mph`)) {
        InlineResponse2003DataInnerObject[["wind_spd_mph"]] <-
          self$`wind_spd_mph`
      }
      if (!is.null(self$`temp_airC`)) {
        InlineResponse2003DataInnerObject[["temp_airC"]] <-
          self$`temp_airC`
      }
      if (!is.null(self$`eto_azmet_in`)) {
        InlineResponse2003DataInnerObject[["eto_azmet_in"]] <-
          self$`eto_azmet_in`
      }
      if (!is.null(self$`heatstress_cottonF`)) {
        InlineResponse2003DataInnerObject[["heatstress_cottonF"]] <-
          self$`heatstress_cottonF`
      }
      if (!is.null(self$`sol_rad_total`)) {
        InlineResponse2003DataInnerObject[["sol_rad_total"]] <-
          self$`sol_rad_total`
      }
      if (!is.null(self$`meta_bat_volt`)) {
        InlineResponse2003DataInnerObject[["meta_bat_volt"]] <-
          self$`meta_bat_volt`
      }
      if (!is.null(self$`precip_total_in`)) {
        InlineResponse2003DataInnerObject[["precip_total_in"]] <-
          self$`precip_total_in`
      }
      if (!is.null(self$`meta_needs_review`)) {
        InlineResponse2003DataInnerObject[["meta_needs_review"]] <-
          self$`meta_needs_review`
      }
      if (!is.null(self$`sol_rad_total_ly`)) {
        InlineResponse2003DataInnerObject[["sol_rad_total_ly"]] <-
          self$`sol_rad_total_ly`
      }
      if (!is.null(self$`eto_azmet`)) {
        InlineResponse2003DataInnerObject[["eto_azmet"]] <-
          self$`eto_azmet`
      }
      if (!is.null(self$`wind_vector_magnitude_mph`)) {
        InlineResponse2003DataInnerObject[["wind_vector_magnitude_mph"]] <-
          self$`wind_vector_magnitude_mph`
      }
      if (!is.null(self$`date_hour`)) {
        InlineResponse2003DataInnerObject[["date_hour"]] <-
          self$`date_hour`
      }
      if (!is.null(self$`temp_soil_10cmF`)) {
        InlineResponse2003DataInnerObject[["temp_soil_10cmF"]] <-
          self$`temp_soil_10cmF`
      }
      if (!is.null(self$`wind_vector_dir_stand_dev`)) {
        InlineResponse2003DataInnerObject[["wind_vector_dir_stand_dev"]] <-
          self$`wind_vector_dir_stand_dev`
      }
      if (!is.null(self$`vp_deficit`)) {
        InlineResponse2003DataInnerObject[["vp_deficit"]] <-
          self$`vp_deficit`
      }
      if (!is.null(self$`wind_spd_max_mps`)) {
        InlineResponse2003DataInnerObject[["wind_spd_max_mps"]] <-
          self$`wind_spd_max_mps`
      }
      if (!is.null(self$`dwptF`)) {
        InlineResponse2003DataInnerObject[["dwptF"]] <-
          self$`dwptF`
      }
      if (!is.null(self$`dwpt`)) {
        InlineResponse2003DataInnerObject[["dwpt"]] <-
          self$`dwpt`
      }
      if (!is.null(self$`wind_vector_magnitude`)) {
        InlineResponse2003DataInnerObject[["wind_vector_magnitude"]] <-
          self$`wind_vector_magnitude`
      }
      if (!is.null(self$`meta_station_name`)) {
        InlineResponse2003DataInnerObject[["meta_station_name"]] <-
          self$`meta_station_name`
      }
      if (!is.null(self$`temp_soil_50cmC`)) {
        InlineResponse2003DataInnerObject[["temp_soil_50cmC"]] <-
          self$`temp_soil_50cmC`
      }
      if (!is.null(self$`relative_humidity`)) {
        InlineResponse2003DataInnerObject[["relative_humidity"]] <-
          self$`relative_humidity`
      }
      if (!is.null(self$`temp_soil_10cmC`)) {
        InlineResponse2003DataInnerObject[["temp_soil_10cmC"]] <-
          self$`temp_soil_10cmC`
      }
      if (!is.null(self$`temp_soil_50cmF`)) {
        InlineResponse2003DataInnerObject[["temp_soil_50cmF"]] <-
          self$`temp_soil_50cmF`
      }
      InlineResponse2003DataInnerObject
    },
    ...
    #' @return the instance of InlineResponse2003DataInner
    #' @export
    ...
    #' Validate JSON input with respect to InlineResponse2003DataInner
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of InlineResponse2003DataInner
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#InlineResponse2003DataInner$unlock()
#
## Below is an example to define the print fnuction
#InlineResponse2003DataInner$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#InlineResponse2003DataInner$lock()
