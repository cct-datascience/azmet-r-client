#' Create a new InlineResponse2004
#'
#' @description
...
InlineResponse2004 <- R6::R6Class(
  ...
  public = list(
    ...
    `errors` = NULL,
    `n` = NULL,
    #' Initialize a new InlineResponse2004 class.
    #'
    #' @description
    #' Initialize a new InlineResponse2004 class.
    #'
    ...
    #' To JSON String
    #'
    #' @return InlineResponse2004 in JSON format
    #' @export
    toJSON = function() {
      InlineResponse2004Object <- list()
      if (!is.null(self$`a`)) {
        InlineResponse2004Object[["a"]] <-
          self$`a`
      }
      if (!is.null(self$`s`)) {
        InlineResponse2004Object[["s"]] <-
          self$`s`
      }
      if (!is.null(self$`data`)) {
        InlineResponse2004Object[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`t`)) {
        InlineResponse2004Object[["t"]] <-
          self$`t`
      }
      if (!is.null(self$`i`)) {
        InlineResponse2004Object[["i"]] <-
          self$`i`
      }
      if (!is.null(self$`l`)) {
        InlineResponse2004Object[["l"]] <-
          self$`l`
      }
      if (!is.null(self$`errors`)) {
        InlineResponse2004Object[["errors"]] <-
          self$`errors`
      }
      if (!is.null(self$`n`)) {
        InlineResponse2004Object[["n"]] <-
          self$`n`
      }
      InlineResponse2004Object
    },
    #' Deserialize JSON string into an instance of InlineResponse2004
    #'
    #' @description
    #' Deserialize JSON string into an instance of InlineResponse2004
    #'
    #' @param input_json the JSON input
    #' @return the instance of InlineResponse2004
    #' @export
...
',
    ...
    #' Validate JSON input with respect to InlineResponse2004
    #'
    #' @description
    #' Validate JSON input with respect to InlineResponse2004 and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of InlineResponse2004
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#InlineResponse2004$unlock()
#
## Below is an example to define the print fnuction
#InlineResponse2004$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#InlineResponse2004$lock()
