#' Create a new InlineResponse2001
#'
#' @description
...
#' @field data  list(\link{InlineResponse2001DataInner}) [optional]
...
InlineResponse2001 <- R6::R6Class(
  ...
  public = list(
    ...
    `errors` = NULL,
    `n` = NULL,
    #' Initialize a new InlineResponse2001 class.
    #'
    #' @description
    #' Initialize a new InlineResponse2001 class.
    #'
    ...
    #' @export
    initialize = function(
        `a` = NULL, `s` = NULL, `data` = NULL, `t` = NULL, `i` = NULL, `l` = NULL, `errors` = NULL, `n` = NULL, ...
    ) {
      if (!is.null(`a`)) {
    ...
    #' To JSON String
    #'
    #' @return InlineResponse2001 in JSON format
    #' @export
    toJSON = function() {
      InlineResponse2001Object <- list()
      if (!is.null(self$`a`)) {
        InlineResponse2001Object[["a"]] <-
          self$`a`
      }
      if (!is.null(self$`s`)) {
        InlineResponse2001Object[["s"]] <-
          self$`s`
      }
      if (!is.null(self$`data`)) {
        InlineResponse2001Object[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`t`)) {
        InlineResponse2001Object[["t"]] <-
          self$`t`
      }
      if (!is.null(self$`i`)) {
        InlineResponse2001Object[["i"]] <-
          self$`i`
      }
      if (!is.null(self$`l`)) {
        InlineResponse2001Object[["l"]] <-
          self$`l`
      }
      if (!is.null(self$`errors`)) {
        InlineResponse2001Object[["errors"]] <-
          self$`errors`
      }
      if (!is.null(self$`n`)) {
        InlineResponse2001Object[["n"]] <-
          self$`n`
      }
      InlineResponse2001Object
    },
    #' Deserialize JSON string into an instance of InlineResponse2001
    #'
    #' @description
    #' Deserialize JSON string into an instance of InlineResponse2001
    #'
    #' @param input_json the JSON input
    #' @return the instance of InlineResponse2001
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[InlineResponse2001DataInner]", loadNamespace("azmet"))
      }
...
',
    ...
    #' Validate JSON input with respect to InlineResponse2001
    #'
    #' @description
    #' Validate JSON input with respect to InlineResponse2001 and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of InlineResponse2001
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#InlineResponse2001$unlock()
#
## Below is an example to define the print fnuction
#InlineResponse2001$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#InlineResponse2001$lock()
