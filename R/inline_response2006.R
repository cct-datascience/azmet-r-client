#' Create a new InlineResponse2006
#'
#' @description
...
InlineResponse2006 <- R6::R6Class(
  ...
  public = list(
    ...
    `errors` = NULL,
    `n` = NULL,
    #' Initialize a new InlineResponse2006 class.
    #'
    #' @description
    #' Initialize a new InlineResponse2006 class.
    #'
    ...
    #' To JSON String
    #'
    #' @return InlineResponse2006 in JSON format
    #' @export
    toJSON = function() {
      InlineResponse2006Object <- list()
      if (!is.null(self$`a`)) {
        InlineResponse2006Object[["a"]] <-
          self$`a`
      }
      if (!is.null(self$`s`)) {
        InlineResponse2006Object[["s"]] <-
          self$`s`
      }
      if (!is.null(self$`data`)) {
        InlineResponse2006Object[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`t`)) {
        InlineResponse2006Object[["t"]] <-
          self$`t`
      }
      if (!is.null(self$`i`)) {
        InlineResponse2006Object[["i"]] <-
          self$`i`
      }
      if (!is.null(self$`l`)) {
        InlineResponse2006Object[["l"]] <-
          self$`l`
      }
      if (!is.null(self$`errors`)) {
        InlineResponse2006Object[["errors"]] <-
          self$`errors`
      }
      if (!is.null(self$`n`)) {
        InlineResponse2006Object[["n"]] <-
          self$`n`
      }
      InlineResponse2006Object
    },
    #' Deserialize JSON string into an instance of InlineResponse2006
    #'
    #' @description
    #' Deserialize JSON string into an instance of InlineResponse2006
    #'
    #' @param input_json the JSON input
    #' @return the instance of InlineResponse2006
    #' @export
...
',
    ...
    #' Validate JSON input with respect to InlineResponse2006
    #'
    #' @description
    #' Validate JSON input with respect to InlineResponse2006 and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of InlineResponse2006
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#InlineResponse2006$unlock()
#
## Below is an example to define the print fnuction
#InlineResponse2006$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#InlineResponse2006$lock()
